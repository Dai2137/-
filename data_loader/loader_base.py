...
class DataLoaderBase(object):
    ...
    def __init__(self, args, logging):
        ...
        # # 5%付与の学習データで学習する場合
        # self.train_file = os.path.join(self.data_dir, 'train_augmented_5.txt')
        # 10%付与の学習データで学習する場合
        # self.train_file = os.path.join(self.data_dir, 'train_augmented_10.txt')
        # # 15%付与の学習データで学習する場合
        # self.train_file = os.path.join(self.data_dir, 'train_augmented_15.txt')

        # 10%付与の学習データの下位10/(10+100)をカットした学習データで学習する場合
        # self.train_file = os.path.join(self.data_dir, 'train_after_cut_10.txt')
